...
// foundry
const riverAirdropAddress = '0x1fA02b2d6A771842690194Cf62D91bdd92BfE28d' satisfies Address
...
// const baseFoundryTokenAddress = '0x1fA02b2d6A771842690194Cf62D91bdd92BfE28d' satisfies Address
  ...
  contracts: [
    ...
    },
    {
      ...
      address: {
        ...
        [foundry.id]: '0x0B306BF915C4d645ff596e518fAf3F9669b97016',
      },
    ...
    },
    {
      ...
      address: {
        [base.id]: omega.address as Address,
        [baseSepolia.id]: gamma.address as Address,
        [foundry.id]: riverAirdropAddress,
      },
      abi: dropFacetAbi,
    },
  ],
