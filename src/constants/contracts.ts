...
export const RVR_TOKEN = {
    ...
    inputs: [
      {
        components: [
          ...
          {
            components: [
              { internalType: 'uint256', name: 'initialInflationRate', type: 'uint256' },
              { internalType: 'uint256', name: 'finalInflationRate', type: 'uint256' },
              { internalType: 'uint256', name: 'inflationDecreaseRate', type: 'uint256' },
              { internalType: 'uint256', name: 'inflationDecreaseInterval', type: 'uint256' },
            ],
  ...
  { inputs: [], name: 'LockAlreadyDisabled', type: 'error' },
  { inputs: [], name: 'LockAlreadyEnabled', type: 'error' },
  ...
  { inputs: [], name: 'River__CannotMint', type: 'error' },
  { inputs: [], name: 'River__CannotMintZero', type: 'error' },
  { inputs: [], name: 'River__DelegateeSameAsCurrent', type: 'error' },
  { inputs: [], name: 'River__InvalidAddress', type: 'error' },
  { inputs: [], name: 'River__InvalidDelegatee', type: 'error' },
  { inputs: [], name: 'River__InvalidInflationRate', type: 'error' },
  { inputs: [], name: 'River__MintingTooSoon', type: 'error' },
  ...
  {
    inputs: [
      { internalType: 'bool', name: '_overrideInflation', type: 'bool' },
      { internalType: 'uint256', name: '_overrideInflationRate', type: 'uint256' },
    ],
